...
data.iloc[1150:1160] # grab any subset of rows to look at
data.flow[1150:1160]  #Grab a subset of just the flow data dat look at
...
ax=data.iloc[11920:11935]['flow'].plot(linewidth=0.5)
